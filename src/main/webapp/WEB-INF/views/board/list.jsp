...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/css/list.css">
</head>
<body>
	<h2>게시글 목록</h2>
	<div class="action">
	...
	<c:forEach var="board"  items="${boardList}">
		<div class="board-item">
			...
			<p>${board.content}</p>
			<p> <fmt:formatDate value="${board.createAt}" pattern="yyyy-MM-dd HH:mm" /></p>
